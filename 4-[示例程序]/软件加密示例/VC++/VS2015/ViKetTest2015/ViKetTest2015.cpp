// ViKetTest2015.cpp : 定义控制台应用程序的入口点。
//

#include "stdafx.h"
#include "ViKey.h"

#pragma comment (lib, "ViKey_X86_VS2015_MT.lib")
...
int main()
{
	...
	//获取加密狗中的时间  只有时间狗才支持
	// 	SVikeyTime time;
	// 	dwRetCode = VikeyGetTime(Index, &time);
	// 	if(dwRetCode)
	// 	{
	// 		printf("VikeyGetTime失败!\n");
	// 	}
	// 	else
	// 	{
	// 		printf("获取时间：%d年%d月%d日-%d时%d分%d秒!\n", time.cYear, time.cMonth, time.cDay, time.cHour, time.cMinute, time.cSecond);
	// 	}
