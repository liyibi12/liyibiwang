Attribute VB_Name = "Module1"
    ...
    Declare Function VikeyUserLogin Lib "ViKey.DLL" (ByVal Index As Integer, ByRef UserPassWord As Byte) As Long
    Declare Function VikeyAdminLogin Lib "ViKey.DLL" (ByVal Index As Integer, ByRef AdminPassWord As Byte) As Long
    Declare Function VikeyLogoff Lib "ViKey.DLL" (ByVal Index As Integer) As Long

    Declare Function VikeySetSoftIDString Lib "ViKey.DLL" (ByVal Index As Integer, ByRef SoftID As Byte) As Long
    Declare Function VikeyGetSoftIDString Lib "ViKey.DLL" (ByVal Index As Integer, ByRef lpSoftID As Byte) As Long
    ...
    Declare Function VikeyResetPassword Lib "ViKey.DLL" (ByVal Index As Integer, ByRef NewUserPassWord As Byte, ByRef NewAdminPassWord As Byte) As Long

    Declare Function VikeyGetTime Lib "ViKey.DLL" (ByVal Index As Integer, ByRef buffer As Byte) As Long
	
    Declare Function VikeyGetUserPassWordAttempt Lib "ViKey.DLL" (ByVal Index As Integer, ByRef pcCurrentAttempt As Byte, ByRef pcMaxAttempt As Byte) As Long
    Declare Function VikeySetUserPassWordAttempt Lib "ViKey.DLL" (ByVal Index As Integer, ByVal pcMaxAttempt As Byte) As Long
    Declare Function VikeyGetAdminPassWordAttempt Lib "ViKey.DLL" (ByVal Index As Integer, ByRef pcCurrentAttempt As Byte, ByRef pcMaxAttempt As Byte) As Long
    Declare Function VikeySetAdminPassWordAttempt Lib "ViKey.DLL" (ByVal Index As Integer, ByVal pcMaxAttempt As Byte) As Long
    Declare Function VikeyGetPtroductName Lib "ViKey.DLL" (ByVal Index As Integer, ByRef szName As Byte) As Long
    Declare Function VikeySetPtroductName Lib "ViKey.DLL" (ByVal Index As Integer, ByRef szName As Byte) As Long
